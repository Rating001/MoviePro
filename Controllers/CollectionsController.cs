...
namespace MoviePro.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        {
            var defaultCollection = _appSettings.MovieProSettings.DefaultCollection.Name;
            var collections = await _context.Collection.Where(c => c.Name != defaultCollection).ToListAsync();
